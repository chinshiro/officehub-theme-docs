...
The **Basic Settings** panel in the TaboQ theme allows you to configure global design, layout, and functionality options that apply across your entire store. All changes are made directly in the **Theme Editor** under **Theme Settings**.
