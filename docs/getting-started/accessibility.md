...
The **Americans with Disabilities Act (ADA)** is a civil rights law that prohibits discrimination based on disability ([Wikipedia](https://en.wikipedia.org/wiki/Americans_with_Disabilities_Act_of_1990)).
...
- Use free tools like [WebAIM Contrast Checker](https://webaim.org/resources/contrastchecker/) to validate your choices.
