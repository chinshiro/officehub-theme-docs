...
All **TaboQ themes are performance-optimized**:
...
| Feature | Dawn (Free) | TaboQ (Premium) |
|--------|------------|----------------|
...
Google’s **Core Web Vitals** directly impact your Pagespeed score. Here’s how TaboQ handles them—and what you can do:

### 📏 CLS (Cumulative Layout Shift)
- **What it is**: Unexpected layout shifts (e.g., images jumping after load).  
- **TaboQ status**: **Optimized by default** (no CLS from theme).  
- **Your action**:  
...
- **TaboQ status**: Smart preloading for likely LCP elements.  
- **Your action**:  
...
- **TaboQ status**: Lightweight, deferred JavaScript.  
- **Your action**:  
