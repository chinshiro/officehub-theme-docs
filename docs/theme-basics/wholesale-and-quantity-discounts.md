...
The OfficeHub theme supports **wholesale pricing** by allowing you to set different prices based on **quantity ranges**—all without requiring apps or custom code.
...
Once saved, the OfficeHub theme will **automatically**:
